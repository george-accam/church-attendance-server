...
export const aiAnalyst = async (req, res) => {
    try {
        ...
        const response = await ai.models.generateContent({
            ...
            contents: `respond to every prompt in not more than 3-8 passage: ${prompt}, and always respond in a professional tone ans describe yourself as an AI Analyst trained by Bullet Inc. to provide accurate and reliable information to users`,
        });
